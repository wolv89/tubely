...
func (cfg *apiConfig) handlerVideoGet(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Unable to generate signed url for video with ID: "+videoID.String(), err)
		return
	}
...
func (cfg *apiConfig) handlerVideosRetrieve(w http.ResponseWriter, r *http.Request) {
	...
	for v := range videos {
		...
		if err != nil {
			respondWithError(w, http.StatusInternalServerError, "Unable to generate signed url for video with ID: "+videos[v].ID.String(), err)
			return
		}
	}
